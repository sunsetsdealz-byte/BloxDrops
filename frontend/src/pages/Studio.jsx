  ...
  return (
    <div className="studio-container">
      <div className="studio-wrapper">
        {!user && (
          <div className="mb-6 glass rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <p className="text-sm text-zinc-300 font-medium">Sign in to start generating — it takes 5-15 seconds.</p>
            <Link to="/register" className="btn-volt rounded-full px-6 py-2.5 text-sm font-bold whitespace-nowrap">Sign up free</Link>
          </div>
        )}
              ...
              <div className="studio-section">
                <div className="studio-mode-switcher">
                  <button
                    ...
                    className={`studio-mode-button ${mode === "text" ? "active" : ""}`}
                  >
                  ...
                  <button
                    ...
                    className={`studio-mode-button ${mode === "image" ? "active" : ""}`}
                  >
                    <ImageSquare size={14} weight="bold" /> Image
                  </button>
                  <button
